...
case '4':
    ...
    foreach ($configFiles as $file) {
        if (file_exists($file)) {
            ...
            $content = str_replace("goldeneggcasino.com", $_POST['domain_name'], $content);
...
<html>
<head>
    <title>Golden Egg Casino Installer</title>
<style>
    body {
...
<div class="installer-form"><div class="message-box">
    ...
    <p>
        ...
        <a href="hhttps://github.com/devflames/goldeneggcasino" target="_blank">Golden Egg Casino</a>
    </p>
    <p>
        Golden Egg Casino link: 
        <a href="goldeneggcasino.com" target="_blank">Golden Egg Casino</a>
    </p>
    <p>
        Sponsor Hosting AWS: 
...
pm2 start Slots.js --watch</pre>
        ...
        <p>Find download packages at goldeneggcasino.com</p>
